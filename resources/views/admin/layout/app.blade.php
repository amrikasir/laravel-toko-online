...
<head>
    ...
    <title>TACELAK CLOTHS [Administrator]</title>
    <!-- plugins:css -->
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item {{ Request::route()->named('admin.pelanggan') ? 'active' : '' }}">
					...
					{{-- menu riwayat order --}}
					<li class="nav-item {{ Request::route()->named('admin.history') ? 'active' : '' }}">
                    ...
                    {{-- menu testimoni users --}}
                    <li class="nav-item {{ Request::route()->named('admin.ulasan') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.ulasan') }}">
                            <span class="menu-title">Ulasan Pembeli</span>
                            <i class="mdi mdi mdi-comment-text-outline menu-icon"></i>
                        </a>
                    </li>
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="ui-basic1">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
									<a class="nav-link {{ Request::route()->named('admin.product') ? 'active' : '' }}" href="{{ route('admin.product') }}">Produk</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ Request::route()->named('admin.categories') ? 'active' : '' }}"
                    ...
                    <li class="nav-item ">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a
                                        class="nav-link {{ Request::route()->named('admin.transaksi') ? 'active' : '' }}"
                                        href="{{ route('admin.transaksi') }}">Pesanan Baru</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ Request::route()->named('admin.transaksi.perludicek') ? 'active' : '' }}"
                                        href="{{ route('admin.transaksi.perludicek') }}">Perlu Di Cek</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ Request::route()->named('admin.transaksi.perludikirim') ? 'active' : '' }}"
                                        href="{{ route('admin.transaksi.perludikirim') }}">Perlu Di Kirim</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ Request::route()->named('admin.transaksi.dikirim') ? 'active' : '' }}"
                                        href="{{ route('admin.transaksi.dikirim') }}">Barang Di Kirim</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ Request::route()->named('admin.transaksi.selesai') ? 'active' : '' }}"
                                        href="{{ route('admin.transaksi.selesai') }}">Selesai</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ Request::route()->named('admin.transaksi.dibatalkan') ? 'active' : '' }}"
